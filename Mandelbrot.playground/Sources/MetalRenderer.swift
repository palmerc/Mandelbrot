...
//            guard let metalBounds = metalView?.bounds else {
//                return
//            }
            let width = 512 //Int(metalBounds.width)
            let height = 512 //Int(metalBounds.height)
...
//            }
            ...
            let threadGroups = MTLSize(width: executionWidth, height: 1, depth:1)
